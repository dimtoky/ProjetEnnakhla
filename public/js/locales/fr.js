...
(function ($) {
    ...
    $.fn.fileinputLocales['fr'] = {
        ...
        msgFileRequired: 'Vous devez choisir un fichier à transférer.',
        msgSizeTooSmall: 'Le fichier "{name}" (<b>{size} Ko</b>) est trop petit et doit étre plus grand que <b>{minSize} Ko</b>.',
        ...
        msgInvalidFileName: 'Caractére non supporté dans le nom du fichier "{name}".',
        ...
        msgUploadEmpty: 'Pas de fichier valide à transférer.',
        ...
        msgAjaxError: 'Une erreur est sur lors {operation}. Veuillez reéssayer!',
        msgAjaxProgressError: '{operation} echoué(e)',
        ajaxOperations: {
            deleteThumb: 'de la suppression',
            uploadThumb: 'du transfert',
            uploadBatch: 'batch file upload',
            uploadExtra: 'form data upload'
        },
        dropZoneTitle: 'Glissez et déposez les fichiers ici&hellip;',
        dropZoneClickTitle: '<br>(ou cliquer pour choisir {files})',
        fileActionSettings: {
        ...
        previewZoomButtonTitles: {
            prev: 'fichier précedent',
            next: 'fichier suivant',
            toggleheader: 'Masquer',
            fullscreen: 'Plein écran',
            borderless: 'Agrandir',
            close: 'Fermé l\'aperçu'
        }
    };
})(window.jQuery);